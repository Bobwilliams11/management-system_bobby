...
Public Class MONTHLY_REPORT_FORM
    ...
    Private Sub MONTHLY_REPORT_FORM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            connection.Open()
            Dim query As String
            query = "Select * From voa.monthly_expenses "
        ...
        Catch ex As MySqlException
            MessageBox.Show("monthly_expenses")
