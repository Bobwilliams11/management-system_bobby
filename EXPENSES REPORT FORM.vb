...
Public Class EXPENSES_REPORT_FORM
    ...
    Private Sub EXPENSES_REPORT_FORM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            connection.Open()
            Dim query As String
            query = "Select * From voa. expenses "
